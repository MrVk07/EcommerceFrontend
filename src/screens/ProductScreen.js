...
function ProductScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(`https://ecommercebackend-9imt.onrender.com/api/products/slug/${slug}`)
  ...
  const addToCartHandler = async () => {
    ...
    const { data } = await axios.get(`https://ecommercebackend-9imt.onrender.com/api/products/${product._id}`);
