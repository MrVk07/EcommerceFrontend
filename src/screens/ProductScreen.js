...
function ProductScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(`https://ecommercebackend-productions.up.railway.app/api/products/slug/${slug}`)
  ...
  const addToCartHandler = async () => {
    ...
    const { data } = await axios.get(`https://ecommercebackend-productions.up.railway.app/api/products/${product._id}`);
